...
/// or the minimum size, and can set the minimum or actual size of this node.
...
public partial class ResizeToFitChildrenControl : Control
{
    ...
    private void RecalculateSize()
    {
        ...
        // CancelDeferred(nameof(ResizeParent));

        CallDeferred(nameof(ResizeParent), newControlSize);
    }

    private void ResizeParent(Vector2 newControlSize)
    {
